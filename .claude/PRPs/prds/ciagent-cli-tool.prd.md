...
| 7.1 | Core infrastructure enhancement | Enhanced MessageChunk types, tool registry, session context, config migration | in-progress | with 6, 8 | 5 | .claude/PRPs/plans/core-infrastructure-enhancement.plan.md |
